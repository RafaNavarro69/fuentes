...
def ppal():
    ...
    xm = 'xmlns:icio="http://www.sevilla.org/ICIO_WS"'
    xm1 = ""
    url = 'http://192.168.52.172:8080/alba2WS-tasas/ICIO/ICIO_WS'

    req_headers = {"content-type": "text/xml"}
    req_body = "<soapenv:Envelope xmlns:soapenv='http://schemas.xmlsoap.org/soap/envelope/' " + xm + ">"
    req_body = req_body + """
                        <soapenv:Header/>
                        <soapenv:Body>
                            <icio:ExisteExpedienteICIO>
                                <icio:NumLicencia>100200052624</icio:NumLicencia>
    ...
    b=response.text.replace(' xmlns="http://www.sevilla.org/ICIO_WS"','')

    print (b)
    arbol=xml.fromstring(b)
